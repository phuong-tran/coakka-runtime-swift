...
Use the exact version `1.3.2`.

Public package links:

| Link | Purpose |
| --- | --- |
| [GitHub Release v1.3.2](https://github.com/phuong-tran/coakka-runtime-swift/releases/tag/v1.3.2) | SwiftPM package release with the macOS ARM64 native runtime. |
