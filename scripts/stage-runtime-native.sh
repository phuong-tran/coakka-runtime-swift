...
if [[ -n "${core_root}" ]]; then
  native_source="${core_root}/build/v2/release-public-native/1.3.4+dc6ec284/package/coakka-runtime-native-v2-1.3.4/native/macos-aarch64/libcoakka_runtime_v2.dylib"
